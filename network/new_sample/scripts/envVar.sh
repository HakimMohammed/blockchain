...
export PEER0_COMPANY_CA=${TEST_NETWORK_HOME}/organizations/peerOrganizations/company.enset.com/tlsca/tlsca.company.enset.com-cert.pem
export PEER0_CUSTOMER_CA=${TEST_NETWORK_HOME}/organizations/peerOrganizations/customer.enset.com/tlsca/tlsca.customer.enset.com-cert.pem
export PEER0_SUPPLIER1_CA=${TEST_NETWORK_HOME}/organizations/peerOrganizations/supplier1.enset.com/tlsca/tlsca.supplier1.enset.com-cert.pem
export PEER0_SUPPLIER2_CA=${TEST_NETWORK_HOME}/organizations/peerOrganizations/supplier2.enset.com/tlsca/tlsca.supplier2.enset.com-cert.pem
...
setGlobals() {
  ...
  elif [ $USING_ORG = "supplier1" ]; then
    export CORE_PEER_LOCALMSPID=Supplier1MSP
    export CORE_PEER_TLS_ROOTCERT_FILE=$PEER0_SUPPLIER1_CA
    export CORE_PEER_MSPCONFIGPATH=${TEST_NETWORK_HOME}/organizations/peerOrganizations/supplier1.enset.com/users/Admin@supplier1.enset.com/msp
    export CORE_PEER_ADDRESS=localhost:9051
  elif [ $USING_ORG = "supplier2" ]; then
    export CORE_PEER_LOCALMSPID=Supplier2MSP
    export CORE_PEER_TLS_ROOTCERT_FILE=$PEER0_SUPPLIER2_CA
    export CORE_PEER_MSPCONFIGPATH=${TEST_NETWORK_HOME}/organizations/peerOrganizations/supplier2.enset.com/users/Admin@supplier2.enset.com/msp
