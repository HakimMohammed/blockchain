...
function createSupplierA() {
  infoln "Enrolling the CA admin"
  mkdir -p organizations/peerOrganizations/supplier_A.enset.com/

  export FABRIC_CA_CLIENT_HOME=${PWD}/organizations/peerOrganizations/supplier_A.enset.com/
  ...
  OrdererOUIdentifier:
    Certificate: cacerts/localhost-9054-ca-supplierA.pem
    OrganizationalUnitIdentifier: orderer' > "${PWD}/organizations/peerOrganizations/supplier_A.enset.com/msp/config.yaml"
...
function createSupplierB() {
  infoln "Enrolling the CA admin"
  mkdir -p organizations/peerOrganizations/supplier_B.enset.com/

  export FABRIC_CA_CLIENT_HOME=${PWD}/organizations/peerOrganizations/supplier_B.enset.com/
  ...
  OrdererOUIdentifier:
    Certificate: cacerts/localhost-10054-ca-supplierB.pem
    OrganizationalUnitIdentifier: orderer' > "${PWD}/organizations/peerOrganizations/supplier_B.enset.com/msp/config.yaml"
