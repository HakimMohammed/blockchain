...
public class LoginController implements Initializable {
    ...
    private void handlePasswordRecovery() {
        ...
        AlertUtils.showInfo(statusLabel, "Password recovery email sent!");
    }

    private void handleSignUp() {
        // Implement sign up navigation logic
        AlertUtils.showInfo(statusLabel, "Sign up feature coming soon!");
    }
